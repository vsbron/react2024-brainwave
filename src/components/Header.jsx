...
function Header() {
  ...
  // Returned JSX
  return (
    <header className="fixed top-0 l-0 w-full z-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm">
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <img src={brainwave} width={190} height={40} alt="Brainwave" />
        </a>
        <nav className="hidden fixed inset-0 top-[5rem] bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent">
